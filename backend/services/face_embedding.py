...
def extract_face_embedding(face: Any) -> list:
    ...
    # Standardize to normal float list (as pgvector expects a list of floats)
    # Cosine similarity is mathematically cleaner when vectors are unit length (L2 normalized)
